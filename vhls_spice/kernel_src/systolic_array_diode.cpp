...
void systolic_array_diode(d_stype A[][M], int IT, x_picked_stream& xp_stream, wdp_stream& y,Ctrl_Stream& sw_in,Ctrl_Stream& sw_out){
#pragma HLS interface s_axilite port=return
#pragma HLS INTERFACE m_axi port=A offset=slave bundle=SAD_Mgen
#pragma HLS INTERFACE s_axilite port=IT

//	*	*	*	*	Define variables for systolic array	*	*	*	*	//
	// local shift regitser of A
	static d_htype A_local[M][4 * Diodes];
